...
export function InterestForm({
  ...
  const { createInterest } = useAccountTransactionMutations();
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Record interest earned or charged on an account
          </DialogDescription>
        </DialogHeader>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Positive for interest earned, negative for interest charged
                    (debt)
                  </FormDescription>
                  <FormMessage />
                </FormItem>
